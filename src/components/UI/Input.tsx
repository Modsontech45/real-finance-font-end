...
const Input = React.forwardRef<HTMLInputElement, InputProps>(({
  ...
  const isOnWhiteBackground = className?.includes('text-black') || 
    document.querySelector('.bg-white, .from-white, .to-gray-50')?.contains(document.activeElement);
      ...
      <div className="relative">
        <input
          ...
          className={clsx(
            ...
            isOnWhiteBackground ? 'text-black placeholder-gray-500' : 'text-white placeholder-transparent',
            'focus:outline-none',
        ...
        {label && (
          <label
            ...
            className={clsx(
              ...
              isOnWhiteBackground ? 'text-black font-medium' : 'text-white/70 font-medium',
              ...
              error && (isFocused || hasValue || props.value || props.defaultValue)
                ? isOnWhiteBackground ? 'text-red-600' : 'text-red-300'
                : ''
            )}
          >
            {label}
