...
import { ChevronRight, DollarSign, TrendingUp, Shield, Smartphone, BarChart3, PieChart, Wallet, Star, ArrowRight, CheckCircle, Users, Calendar, Bell } from 'lucide-react';
...
const FinanceLandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Access your finances anywhere with seamless device synchronization"
    },
    {
      icon: <Bell className="w-8 h-8" />,
      title: "Smart Notifications",
      description: "Get alerts for unusual spending, bill reminders, and budget limits"
    }
  ];

  const testimonials = [
    { name: "Sarah Johnson", role: "Small Business Owner", text: "Finally got my finances under control. The insights are game-changing!" },
    { name: "Mike Chen", role: "Freelancer", text: "The budgeting tools helped me save $5,000 in just 6 months." },
    { name: "Lisa Rodriguez", role: "Financial Advisor", text: "I recommend this to all my clients. It's incredibly comprehensive." }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-900 text-white overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className={`relative z-10 max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight">
            Master Your Money,
            <br />
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            The most intelligent finance app that transforms chaos into clarity. Track, analyze, and optimize your financial life with AI-powered insights.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            ...
            <button 
              onClick={() => window.open('https://financedemo-phi.vercel.app/login')}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className={`text-center transition-all duration-1000 delay-${index * 200} ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
        ...
        <div className="absolute bottom-20 left-20 animate-bounce delay-3000">
          <div className="bg-emerald-600/20 p-3 rounded-xl backdrop-blur-sm">
      ...
      {/* Benefits Section */}
      <div className="py-20 px-4 bg-gradient-to-r from-purple-900/20 to-pink-900/20">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-emerald-600 to-black p-8 rounded-3xl backdrop-blur-sm border border-white/10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 hover:border-purple-500/30 transition-all duration-300">
