...
const NoticeBoardPage: React.FC = () => {
  ...
  const { reports, isLoading, isCreating, createReport, deleteReport } =
    useReports();
      ...
      <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 rounded-2xl p-8 text-white">
        <div>
          ...
          <p className="text-blue-100 text-lg">
            Manage weekly reports and important documents
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {watchType === "text" && (
              <div>
                ...
                <textarea
                  {...register("content", {
                    required: "Content is required for text reports",
                  })}
                  rows={6}
            ...
            {watchType === "pdf" && (
              <div>
                ...
                <input
                  ...
                  accept=".pdf"
                  {...register("file", {
                    required: "File is required for PDF reports",
                  })}
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredReports.map((report) => (
            <Card
              key={report.id}
              className="hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-0 bg-gradient-to-br from-white to-gray-50 text-black"
            >
